\newcommand{\ignorealign}[1]{\clap{$\dps{#1}$}}
...
\newcommand{\perm}[2]{\mathrm{P}\left( #1, #2 \right)}
\newcommand{\multiset}[2]{\ensuremath{\left(\kern-.5em\left( \begin{matrix} #1 \\ #2 \end{matrix} \right)\kern-.5em\right)}}
\newcommand{\prob}[1]{\mathbb{P}\bracks{#1}}
\newcommand{\expect}{\mathbb{E}\hspace{0.13em}}
...
\newcommand{\laplace}[1]{\cll\braces{#1}}
